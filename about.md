...
This is the second in a two-semester course. With much of the background of triangulated categories set, we focus on 
the structure of derived categories of (quasi-)coherent sheaves on schemes. 
...
- Localize triangulated categories for fun and profit
...
- the [course website](https://748.s221.matthewrobertballard.com), 
